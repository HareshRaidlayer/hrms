                    ...
                    <form autocomplete="off" method="post" id="sample_form" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="candidate_id[]" id="candidate_id" required class="selectpicker form-control"
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="interview_place" id="interview_place" required
                                    class="form-control" placeholder="{{ __('Interview Place') }}">
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="interview_time" id="interview_time" required
                                    class="form-control time" placeholder="{{ __('Interview Time') }}">
                            </div>
                            ...
                            <div class="container">
                                <div class="form-group" align="center">
                                    <button type="submit" name="action_button" id="action_button" class="btn btn-warning"
                                        value="{{ trans('file.Submit') }}">Add </button>
                                </div>
                            </div>
                        </div>
            ...
            $('#saveQuestions').on('click', function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        var html = '<div class="aalert alert-danger">Something went wrong while saving.</div>';
                     $('#general_result').html(html).slideDown(300).delay(5000).slideUp(300);
                    }
                });
            });
