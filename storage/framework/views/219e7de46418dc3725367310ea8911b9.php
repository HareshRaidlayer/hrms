<?php $__env->startSection('content'); ?>
        ...
        <?php if(env('USER_VERIFIED')): ?>
            <div id="alertSection" class="<?php echo e($versionUpgradeData['alert_version_upgrade_enable']==true ? null : 'd-none'); ?> alert alert-primary alert-dismissible fade show" role="alert">
                <p id="announce"><strong>Announce !!!</strong> A new version <?php echo e($versionUpgradeData['demo_version']); ?> has been released. Please <i><b><a href="<?php echo e(route('new-release')); ?>">Click here</a></b></i> to check upgrade details.</p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/hrms/resources/views/dashboard/admin_dashboard.blade.php ENDPATH**/ ?>